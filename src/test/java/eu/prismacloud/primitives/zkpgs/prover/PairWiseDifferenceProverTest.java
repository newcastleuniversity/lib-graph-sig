...
class PairWiseDifferenceProverTest {
	...
	void testCreateWitnessRandomness() throws ProofStoreException {
		...
		log.info("tildeR:"
				+ "\n  maximum positive random number for witnesses: " + maxR
	 ...
	 * 
	 * <p>Finally, the test case calls the self-verification of the PairWiseDifferenceProver
	...
	void testPostChallengePhase() throws ProofStoreException, NoSuchAlgorithmException, InterruptedException {
		...
		assertTrue(prover.verify(), "PairWiseDifferenceProver self-verification post-challenge failed.");
	}
}
