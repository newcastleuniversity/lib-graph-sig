...
public class QRElementPQ extends QRElement {
    ...
    public QRElementPQ(final QRGroupPQ qrGroupPQ, final BigInteger value, final BigInteger pPrime, final BigInteger qPrime) {
        super(qrGroupPQ, value);
        this.qrGroupPQ = qrGroupPQ;
        this.value = value;
...
//      compute exponentiation using CRT for modulo p and q representation
        ...
        return CRT.computeCRT(xp, this.qrGroupPQ.getOneP(), xq, this.qrGroupPQ.getOneQ(), this.pPrime.multiply(this.qPrime));
    ...
    public BigInteger multiply(BigInteger val) {
        ...
        // uses precomputation for 1p and 1q
        return CRT.computeCRT(xp1.multiply(xp2), this.qrGroupPQ.getOneP(), xq1.multiply(xq2), this.qrGroupPQ.getOneQ(), this.pPrime.multiply(this.qPrime));
    }
