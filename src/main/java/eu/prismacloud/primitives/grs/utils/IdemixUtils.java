 ...
 *
 * @see eu.prismacloud.primitives.grs.utils.INumberUtils
 */
  ...
  public SafePrime generateRandomSafePrime() {
    BigInteger p =
        Utils.computeSafePrime(
            KeyGenParameters.l_n.getValue() / 2, KeyGenParameters.l_pt.getValue());
    ...
    if (sp == null) {
      sp =
          new SystemParameters(
              KeyGenParameters.l_e.getValue(),
              KeyGenParameters.l_prime_e.getValue(),
              KeyGenParameters.l_gamma.getValue(),
              KeyGenParameters.l_H.getValue(),
              0,
              KeyGenParameters.l_m.getValue(),
              KeyGenParameters.l_n.getValue(),
              KeyGenParameters.l_0.getValue(),
              KeyGenParameters.l_pt.getValue(),
              KeyGenParameters.l_r.getValue(),
              KeyGenParameters.l_res.getValue(),
              KeyGenParameters.l_rho.getValue(),
              KeyGenParameters.l_v.getValue(),
              0);
      return sp;
    } else return this.sp;
  }
