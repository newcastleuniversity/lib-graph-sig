...
public class GSGraphSignature implements IGraphSignature {
    ...
    public IGraphSignature hiddenSign(ICommitment cmt, IGraph recipientGraph, IGraph signerGraph, ISignerPublicKey pk_s) {
        return null;
    }
	...
	public IGraphSignature hiddenSign(ICommitment cmt, IGraph recipientGraph, IGraph signerGraph,
			SignerPublicKey pk_s) {
