...
import eu.prismacloud.primitives.grs.*;
...
/**
 * Algorithm 11 - topocert-doc
 * Key generation algorithm for the graph signature scheme and commitment scheme
...
//        generateRandomSafePrime q= 2q' + 1
    ...
    public GSGraphSignature hiddenSign(GSCommitment cmt, GSVertex signerVertex, GSVertex recipientVertex, ExtendedPublicKey extendedPublicKey, GSGraph gsGraph1, ExtendedPrivateKey extendedPrivateKey) {
        return null;
