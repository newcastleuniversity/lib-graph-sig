 ...
 * for it.
 */
public class IssuingCommitmentProver extends AbstractCommitmentProver {
	...
	@Override
	public URN getTildeRandomnessURN(int index) {
		throw new RuntimeException("URNType " + URNType.TILDEVPRIME 
				+ " is not enumerable and should not be called with a commitment index.");
	}
	...
	protected URN getHatRandomnessURN(int index) {
		throw new RuntimeException("URNType " + URNType.HATVPRIME 
				+ " is not enumerable and should not be called with a commitment index.");
	}
