...
public class GroupSetupProver implements IProver {
	...
	/** 
	 * This method returns a single witness for Z, even though the prover creates
	 * a compound proof with many witnesses.
	 * 
	 * <p>All witnesses created are stored in the ProofStore as a side condition,
	 * under their appropriate URNs. It is preferable to call executeCompoundPreChallengePhase().
	 * 
