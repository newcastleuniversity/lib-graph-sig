...
public class CommitmentVerifier implements IVerifier {
    ...
    public CommitmentVerifier(BigInteger cChallenge, int baseIndex, ExtendedPublicKey extendedPublicKey, ProofStore<Object> proofStore) {
    }

    public CommitmentVerifier(BigInteger cChallenge, int baseIndex, ExtendedPublicKey extendedPublicKey, ProofStore<Object> proofStore, ExtendedPublicKey extendedPublicKey1) {
