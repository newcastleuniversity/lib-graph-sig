...
public class KeyGenParameters implements Serializable, IContextProducer {
	...
	public void addToChallengeContext(List<String> ctxList) {
		ctxList.add(String.valueOf(this.getL_n()));
		ctxList.add(String.valueOf(this.getL_gamma()));
		ctxList.add(String.valueOf(this.getL_rho()));
		ctxList.add(String.valueOf(this.getL_m()));
		ctxList.add(String.valueOf(this.getL_res()));
		ctxList.add(String.valueOf(this.getL_e()));
		ctxList.add(String.valueOf(this.getL_prime_e()));
		ctxList.add(String.valueOf(this.getL_v()));
		ctxList.add(String.valueOf(this.getL_statzk()));
		ctxList.add(String.valueOf(this.getL_H()));
		ctxList.add(String.valueOf(this.getL_r()));
		ctxList.add(String.valueOf(this.getL_pt()));
	}
}
