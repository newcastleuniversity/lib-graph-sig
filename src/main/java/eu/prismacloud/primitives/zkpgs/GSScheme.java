...
import eu.prismacloud.primitives.zkpgs.signer.ISigner;
...
public class GSScheme {
  ...
  public static void main() {
    ...
    BigInteger rndRecipient = Utils.computeRandomNumberSymmetric(keyGenParameters.getL_statzk());
    ...
    BigInteger rndVerifier = Utils.computeRandomNumberSymmetric(keyGenParameters.getL_statzk());
    Boolean result =
        recipient.verify(
            graphEncoding.getExtendedPublicKey(),
            recipientCommitment,
