...
public class GSSignature implements Serializable {
	...
	public String toString() {
		...
		sb.append(", ePrimeOffset=").append(ePrimeOffset);
		sb.append(", A=").append(A);
		sb.append(", e=").append(e);
		sb.append(", ePrime=").append(ePrime);
		sb.append(", v=").append(v);
		sb.append(", encodedBases=").append(encodedBases);
		sb.append(", graphRepresentation=").append(graphRepresentation);
		sb.append(", a=").append(getA());
		sb.append(", EPrime=").append(getEPrime());
		sb.append(", EPrimeOffset=").append(getEPrimeOffset());
//		sb.append(", blind=").append(blind());
		sb.append(", hasValidE=").append(hasValidE());
		sb.append(", hasValidLengthE=").append(hasValidLengthE());
		sb.append(", hasValidLengthV=").append(hasValidLengthV());
		sb.append('}');
		return sb.toString();
	}
}
