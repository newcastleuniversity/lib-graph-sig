...
/**
 * Creates a prover orchestrator for the binding credentials
 */
public class ProverOrchestratorBC implements IProverOrchestrator {
	private final ExtendedPublicKey extendedPublicKey;
	private final KeyGenParameters keyGenParameters;
	private final GraphEncodingParameters graphEncodingParameters;
	private final ProofStore<Object> proofStore;
	private final GSProver prover;
	...
	public ProverOrchestratorBC(final ExtendedPublicKey extendedPublicKey, final IMessageGateway messageGateway) {
	...
	public void init() throws IOException {
		...
		if (baseCollection == null) {
			throw new IOException("The graph signature's base collection has not been read, deserializu e from file or read from proof-store.");
		}
...
//		try {
//			prover.computeCommitments(baseCollection.createIterator(BaseRepresentation.BASE.VERTEX));
...
//		proofStore.store(commitmentsURN, commitments);
	...
	@Override
	public void executePostChallengePhase(BigInteger cChallenge) throws ProofStoreException, IOException {
