...
public class TopocertCmdLineParser extends CmdLineParser {
	...
	public static final Option PSEUDONYM = new CmdLineParser.Option.StringOption('U', "pseudonym");
	...
	public TopocertCmdLineParser() {
		...
		addHelp(VERTEX_CREDENTIAL, "Switches to computing vertex credentials.");
		addHelp(PSEUDONYM, "Specifies file storing pseudonyms for vertex credentials.");
	...
	public Option[] getStdOptions() {
		return new CmdLineParser.Option[] {KEYGEN, SIGN, RECEIVE, PROVE, VERIFY, GRAPHFILENAME, GEOSEPQUERY, GSSIGNATURE,
				KEYGENPARAMS, SIGNERKP, EPK, HOST_ADDRESS, PORT_NUMBER, VERBOSE, VERTEX_CREDENTIAL, HELP};
	}
}